...
const ReportsFram = ({
  ...
  return (
    <>
      <section className="form_container" id="tagnewsecboxid">
      ...
      <section className="pur_sec_table">
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12">
              <div className="pur_sec_table-box">
                <table>
                  {smallTable.map((val, index) => {
                    return (
                      <tr>
                        <th className="blue">{val.replace("_", " ")} :</th>
                        <td>
                          <div className="form-group-box">
                            <input
                              type="number"
