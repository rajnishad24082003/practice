import { Reports_TagOtherDetailFun } from "../../context/DataCollector";
const TagOtherDetail = () => {
  return (
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group-box">
                  <input
                    onChange={Reports_TagOtherDetailFun}
